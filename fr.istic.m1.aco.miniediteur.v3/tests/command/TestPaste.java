...
public class TestPaste {
	...
	public void testExecute() {
		...
		command.execute();
		Assert.assertTrue("Execute() - clipboard content error", clipboard.getText().equals("test"));
		Assert.assertTrue("Execute() - buffer content error", buffer.getText().equals("test"));
		Assert.assertTrue("Execute() - selection variables error", selection.getStart() == 4 && selection.getLength() == 0);
